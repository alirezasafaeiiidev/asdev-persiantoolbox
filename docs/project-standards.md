...
- گیت قراردادی سبک باید در CI اجرا شود:
  - `pnpm ci:contracts`
  - شامل validate برای artifactهای monetization/deploy/release و `pwa:sw:validate`
...
- نقشه‌راه‌ها و task planها باید اولویت‌محور باشند (نه زمان‌بندی کوتاه/بلندمدت).
