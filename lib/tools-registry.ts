...
export const toolsRegistry: ToolEntry[] = [
  {
    ...
    description: 'همه ابزارها و مسیرهای پیشنهادی در یک صفحه',
    indexable: true,
    lastModified: '2026-02-04',
    kind: 'hub',
    content: {
      intro:
        'در این صفحه می‌توانید به همه ابزارهای فارسی دسترسی داشته باشید و بدون پیچیدگی، سریع وارد ابزار موردنیازتان شوید.',
      tips: [
        'برای شروع سریع، از مسیرهای پیشنهادی استفاده کنید.',
